...
async function loadFacts() {
  const res = await fetch(
    "https://aigvrzfbwquobswctixl.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFpZ3ZyemZid3F1b2Jzd2N0aXhsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDUzMzUwMzMsImV4cCI6MjAyMDkxMTAzM30.qAQxTboiA5MnAhjVKbbIpji6UxqcMy8I00JtNNGIuBk",
      },
    }
  );
